...
def open_page4(previous_root):
    ...
    def change_to_group1 ():
        image_config()
        change_to_dataword1()

    def change_to_group2 ():
        image_config()
        change_to_dataword2()

    def change_to_group3 ():
        image_config()
        change_to_dataword3()

    def change_to_group4 ():
        image_config()
        change_to_dataword4()

    def change_to_group5 ():
        image_config()
        change_to_dataword5()

    def change_to_group6 ():
        image_config()
        change_to_dataword6()
...
#################################################################
    am_button = tk.Button(frame,image=photo1_p4,borderwidth=0,bg='#D3F2FF', command=change_to_group2)
    am_button.grid(row=2,column=0,pady=15,sticky= 'w')
#################################################################
    op_button = tk.Button(frame,image=photo2_p4,borderwidth=0,bg='#D3F2FF', command=change_to_group3)
    op_button.grid(row=2,column=0,pady=15,sticky= 'e')

    lc_button = tk.Button(frame,image=photo3_p4,borderwidth=0,bg='#D3F2FF',command=change_to_group4)
    lc_button.grid(row=3,column=0,pady=15,sticky= 'w')

    it_button = tk.Button(frame,image=photo4_p4,borderwidth=0,bg='#D3F2FF',command=change_to_group5)
    it_button.grid(row=3,column=0,pady=15,sticky= 'e')

    sp_button = tk.Button(frame,image=photo5_p4,borderwidth=0,bg='#D3F2FF',command=change_to_group6)
    sp_button.grid(row=4,column=0,pady=15,sticky= 'w')

    an_button = tk.Button(frame,image=photo6_p4,borderwidth=0,bg='#D3F2FF',command=change_to_group1)
