...
def open_page4(previous_root):
    ...
    label1.grid(row=0,column=0,padx= 60)
...
#################################################################
    ...
    lc_button = tk.Button(frame,image=photo5_p4,borderwidth=0,bg='#D3F2FF')
    lc_button.grid(row=4,column=0,pady=15,sticky= 'w')

    it_button = tk.Button(frame,image=photo6_p4,borderwidth=0,bg='#D3F2FF')
    it_button.grid(row=4,column=0,pady=15,sticky= 'e')

    s_button = tk.Button(frame,image=ba_p4,borderwidth=0, bg='#D3F2FF', command=lambda: back_to_page1(root))
    s_button.grid(row=5,column=0,pady=5,sticky='w')


    add_word_button = tk.Button(frame,image=up_p4,borderwidth=0, bg='#D3F2FF',command=lambda: open_page2(root))
    add_word_button.grid(row=5,column=0,pady=5,sticky='e')
